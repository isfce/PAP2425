...
#Ouverture du fichier avec l'encodage "chemin à adapter chez vous"
nom = 'c:/aaa/listeAchats.txt'
try:#gère les exceptions d'erreurs
    #ouvre le fichier en écriture avec un encodage 'utf8'
    # x--> le fichier ne peut pas exister
    with open(nom,'x',encoding = 'utf8') as f:
        for achat in achats:
